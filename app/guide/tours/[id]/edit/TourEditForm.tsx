...
export default function TourEditForm({ tour }: TourEditFormProps) {
  ...
  const [formData, setFormData] = useState({
    title: tour.title_ko || tour.title || "",
    description: tour.description_ko || tour.description || "",
    region: tour.region_ko || tour.region || "",
    meetingPoint: tour.meeting_point_ko || "",
    duration: tour.duration?.toString() || "",
    price: tour.price?.toString() || "",
    maxGuests: tour.max_guests?.toString() || "4",
    includedItems: Array.isArray(tour.included_items_ko)
