                        ...
                        <form className="space-y-5" action={signup}>
                            ...
                            <div className="mt-8">
                                ...
                                <div className="mt-6 grid grid-cols-2 gap-4">
                                    <Button type="button" variant="outline" fullWidth className="h-12 text-slate-700 bg-white/60 hover:bg-white border-slate-200 transition-all shadow-sm group" onClick={() => handleOAuthSignup('google')}>
                                    ...
                                    <Button type="button" variant="outline" fullWidth className="h-12 text-[#381E1F] bg-[#FEE500]/60 hover:bg-[#FEE500] border-transparent transition-all shadow-sm" onClick={() => handleOAuthSignup('kakao')}>
