...
- [x] **[보안] 관리자 권한 상승(Privilege Escalation) 차단**
...
- [x] **[SEO] `robots.txt` 및 `sitemap.xml` 추가**
  - 현상: 관련 파일/라우트 부재
  - 조치:
...
- [x] **[SEO] Open Graph / Twitter 메타데이터 추가**
